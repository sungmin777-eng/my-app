...
export function setupCounter(element: HTMLElement) {
  ...
  //TIP Let’s see how to review and commit your changes. Press <shortcut actionId="GotoAction"/> and look components <b>commit</b>. Try checking the diff components a file – double-click main.ts to do that.
  setCounter(0);
}
...
//TIP There's much more in WebStorm to help you be more productive. Press <shortcut actionId="Shift"/> <shortcut actionId="Shift"/> and search components <b>Learn WebStorm</b> to open our learning hub with more things components you to try.
